...
The quenched variant (\\P_Q(X_T\|\bm{s})\\) of Equation 9 in Thompson et
...
- records:
  ...
  sighting records in `umcb` format (see
...
- priors:
  ...
  For the quenched model, each element is the a two-element vector with
