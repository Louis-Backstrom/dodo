...
- record.check:
  ...
  what to do with uncertain sightings that occur in the same time
  interval as a certain sighting (a violation of an assumption of the
  model. Two options: `error` (default, throws an error) and `remove`
