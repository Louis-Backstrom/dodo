#' @title Brook et al.'s (2019) "Solow" model
#'
#' @description
#' The Solow 1993a variant of the model from Brook et al. 2019. Estimates a
#' "probability" of extinction at the test time, and a two-tailed
...
#'
#' @seealso [BR19F2()], [BR19F3()], [BR19F4()], [BR19F5()]
#'
#' @examples
#' # Run the "Extreme" Ivory-billed Woodpecker analysis from Brook et al. 2019
#' BR19F1(woodpecker$ucon, test.time = 2010, alpha = 0.1, cores = 2,
#'        n.iter = 1e3)
...
#' \dontrun{BR19F1(curlew$ucon, test.time = 2022, cores = 2, n.iter = 1e3)}
#'
#' @export
